...
-- update previously defined trigger function definition removing code related to alternative names, which is now handled by alternative_musical_entry_names table
